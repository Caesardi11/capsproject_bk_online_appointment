<form action="{{ route('editJadwalProses', $jadwal->id) }}" method="POST">
    ...
    <div>
        <label for="time" class="block text-sm font-medium leading-6 text-gray-900">Pilih Jam
            Mulai</label>
        <div class="mt-2">
            <input id="jam_mulai" name="jam_mulai" type="time" required value="{{ $jadwal->jam_mulai }}"
                class="block w-full px-3 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
        </div>
    </div>
    ...
    <div>
        <label for="time" class="block text-sm font-medium leading-6 text-gray-900">Pilih Jam
            Selesai</label>
        <div class="mt-2">
            <input id="jam_selesai" name="jam_selesai" type="time" required value="{{ $jadwal->jam_selesai }}"
                class="block w-full px-3 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
        </div>
    </div>
