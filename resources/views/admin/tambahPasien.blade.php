...
@section('content')
    <div>
        <p class="text-3xl text-gray-800 font-bold">Tambah Akun Pasien</p>
    </div>
    <div>
        <i>
            <ol class="list-reset flex mt-3">
                ...
                <li class="text-neutral-500">Tambah Akun Pasien</li>
            </ol>
        </i>
    </div>
    <div class="mt-16">
        <form class="space-y-6" action="{{ route('tambahPasienProses') }}" method="POST">
            @csrf
            <div>
            ...
            <div>
                <button type="submit"
                    class="flex w-full justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Tambah
                    Pasien</button>
            </div>
        </form>
    </div>
