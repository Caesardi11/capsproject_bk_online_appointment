...
@section('content')
    <div>
        <p class="text-3xl text-gray-800 font-bold">Edit Daftar Obat</p>
    </div>
    <div>
        <i>
            <ol class="list-reset flex mt-3">
                ...
                <li class="text-neutral-500">Edit Daftar Obat</li>
            </ol>
        </i>
    </div>
    <div class="mt-16">
        <form action="{{ route('editObatProses', $obat->id) }}" method="POST">
            @csrf
            @method('PUT')
            <div>
