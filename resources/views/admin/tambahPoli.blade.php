...
@section('content')
    <div>
        <p class="text-3xl text-gray-800 font-bold">Tambah Daftar Poli</p>
    </div>
    <div>
        <i>
            <ol class="list-reset flex mt-3">
                ...
                <li class="text-neutral-500">Tambah Daftar Poli</li>
            </ol>
        </i>
    </div>
    <div class="mt-16">
        <form action="{{ route('tambahPoliProses') }}" method="POST">
            @csrf
            <div>
